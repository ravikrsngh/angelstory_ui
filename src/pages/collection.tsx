...
const CollectionAssets = ({assetList, collectionId}:{assetList:AssetResType[] | undefined, collectionId:number|undefined}) => {
  return (
          ...
          <Tab.Group>
            <Tab.List>
              <div className="flex gap-4 border-b border-slate-300 items-center mb-8">
                ...
                <Link className="ml-auto text-xs md:text-sm lg:text-base" to={`/collection/${collectionId}/assets`}>
                  View all assets
                </Link>
              </div>
            </Tab.List>
  ...
  return (
    <div className="px-4 md:px-10 lg:px-16 py-8 flex flex-col gap-10">
      <div className="relative rounded-md overflow-hidden p-4 pt-10 pb-5 md:p-10 md:pt-[140px] lg:pt-[200px] bg-primary-200 text-primary-950">
        ...
        <h4 className="text-3xl md:text-4xl lg:text-5xl font-medium">{data?.name}</h4>
      </div>
